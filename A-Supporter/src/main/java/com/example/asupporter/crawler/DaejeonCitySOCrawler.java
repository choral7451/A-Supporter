...
@Controller
public class DaejeonCitySOCrawler {
    ...
    public void daejeonCitySOCrawler() {
    	try {
    		String originalURL = "https://dpo.artdj.kr/dpo/?a_idx=06_01";
	        ...
	        System.out.println("*-----------------------------------------*");
            System.out.println("|     대전시립교향악단     |"+"         " +count+"          |");
    	} catch (Exception e) {
    		e.printStackTrace();
    	}
    }
