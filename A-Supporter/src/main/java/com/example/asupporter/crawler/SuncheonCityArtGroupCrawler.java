...
@Controller
public class SuncheonCityArtGroupCrawler {
    ...
    public void suncheonCityArtGroupCrawler() {
    	try {
	    	String originalURL = "https://www.suncheon.go.kr/scart/community/0001/";
	        ...
	        System.out.println("*-----------------------------------------*");
            System.out.println("|      순천시립예술단     |"+"         " +count+"          |");
    	} catch (Exception e) {
    		e.printStackTrace();
    	}
    }
