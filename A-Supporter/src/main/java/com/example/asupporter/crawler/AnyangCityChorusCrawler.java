...
@Controller
public class AnyangCityChorusCrawler {
    ...
    public void anyangCityChorusCrawler() {
    	try {
	    	String originalURL = "https://www.anyang.go.kr/acc/selectBbsNttList.do?bbsNo=335&key=2166";
	        ...
	        System.out.println("*-----------------------------------------*");
            System.out.println("|      안양시립합창단     |"+"         " +count+"          |");
    	} catch (Exception e) {
    		e.printStackTrace();
    	}
    }
