...
@Controller
public class WonjuCityArtGroupCrawler {
    ...
    public void wonjuCityArtGroupCrawler() {
    	try {
    		String originalURL = "https://www.wonju.go.kr/arts/pr/notice.html";
	        ...
	        System.out.println("*-----------------------------------------*");
            System.out.println("|     원주시립예술단     |"+"         " +count+"          |");
    	} catch (Exception e) {
    		e.printStackTrace();
    	}
    }
