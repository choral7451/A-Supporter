...
@Controller
public class SeongnamCityArtGroupCrawler {
    ...
    public void seongnamCityArtGroupCrawler() {
		
    	try {
	    	String originalURL = "https://art.seongnam.go.kr:10021/contents/content.php?cIdx=39&fboard=board_news";
	        ...
	        System.out.println("*-----------------------------------------*");
            System.out.println("|      성남시립예술단     |"+"         " +count+"          |");
    	} catch (Exception e) {
    		e.printStackTrace();
    	}
    }
