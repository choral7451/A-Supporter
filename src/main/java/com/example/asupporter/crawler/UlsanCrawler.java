...
public class UlsanCrawler {
    ...
    public void ulsanCrawler() {
        try {
            ...
            String nowDate = "2022-02-15";
//                    LocalDateTime.now().minusDays(9).format(DateTimeFormatter.ofPattern("yyyy-MM-dd"));

            for (int i = 7 ; i < 12 ; i++) {
                String getDate = ul.select("li:nth-child(" + i + ")").first().children().select("p:nth-child(4)").text();
